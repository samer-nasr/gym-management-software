...
Route::middleware('auth')->group(function () {
    ...
    Route::get('expired_memberships', [MemberController::class, 'expired_memberships'])->name('expired_memberships');
    Route::get('search_for_expired_membership', [MemberController::class, 'search_for_expired_membership'])->name('search_for_expired_membership');
